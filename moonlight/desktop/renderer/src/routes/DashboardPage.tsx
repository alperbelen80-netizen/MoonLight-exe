    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <KPICard
          ...
          color={summary.live_win_rate_7d > 0.6 ? 'green' : summary.live_win_rate_7d > 0.5 ? 'gray' : 'red'}
        />
        <KPICard
          title="PnL Today"
        ...
        <KPICard
          title="Trades Today"
          value={summary.daily_trade_count}
          color="blue"
        />
        <KPICard
          title="Global Health"
          ...
          color={summary.global_health_color === 'GREEN' ? 'green' : summary.global_health_color === 'AMBER' ? 'gray' : 'red'}
        />
        <KPICard
        ...
        <KPICard
          title="Trades (7d)"
          value={summary.live_trade_count_7d}
          color="gray"
        />
      </div>
